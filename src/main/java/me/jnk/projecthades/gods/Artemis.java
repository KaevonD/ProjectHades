...
public class Artemis implements God {
    ...
    public GuiItem getGod() {
        List<Component> lore = Arrays.asList(
                Component.text("Blessings granted by Artemis,"),
                Component.text("the goddess of the hunt"));

        return ItemBuilder.from(Material.BOW)
                .name(Component.text(ChatColor.GREEN + "" + ChatColor.BOLD + "Artemis Blessing"))
                .lore(lore)
                .asGuiItem(event -> {
