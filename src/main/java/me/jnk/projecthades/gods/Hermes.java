...
public class Hermes implements God {
    ...
    public GuiItem getGod() {
        List<Component> lore = Arrays.asList(
                Component.text("Blessings granted by Hermes,"),
                Component.text("the god of travel"));

        return ItemBuilder.from(Material.FEATHER)
                .name(Component.text(ChatColor.WHITE + "" + ChatColor.BOLD + "Hermes Blessing"))
                .lore(lore)
                .asGuiItem(event -> {
