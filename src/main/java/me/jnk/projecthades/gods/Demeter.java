...
public class Demeter implements God {
    ...
    public GuiItem getGod() {
        List<Component> lore = Arrays.asList(
                Component.text("Blessings granted by Demeter,"),
                Component.text("the goddess of harvest"));

        return ItemBuilder.from(Material.SNOWBALL)
                .name(Component.text(ChatColor.AQUA + "" + ChatColor.BOLD + "Demeter Blessing"))
                .lore(lore)
                .asGuiItem(event -> {
