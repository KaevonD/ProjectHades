...
public class Poseidon implements God {
    ...
    public GuiItem getGod() {
        List<Component> lore = Arrays.asList(
                Component.text("Blessings granted by Poseidon,"),
                Component.text("the god of the sea"));

        return ItemBuilder.from(Material.TRIDENT)
                .name(Component.text(ChatColor.BLUE + "" + ChatColor.BOLD + "Poseidon Blessing"))
                .lore(lore)
                .asGuiItem();
    }
